...
from send import damiao as script
...
class EnableDm8009Id1Tests(unittest.TestCase):
    ...
    def test_main_dry_run_defaults_to_enable_only_output(self):
        stream = io.StringIO()
        ...
        self.assertIn("default_behavior=enable_only", output)
        self.assertIn("default_command=enable_only", output)
        self.assertIn("enable_frame", output)
        self.assertNotIn("zero_mit_frame", output)
